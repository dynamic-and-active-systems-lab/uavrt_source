...
void airspy_channelize(double rawSampleRate, double decimationFactor)
{
  ...
  /* allDivisors         =
   * unique([divisors(192000),divisors(256000),divisors(384000),divisors(456000),divisors(768000),divisors(912000)]);
   */
  ...
  /* allDivisors256Max = [2; 3; 4; 5; 6; 8; 10; 12; 15; 16; 19; 20; 24; 25; 30;
   * 32; 38; 40; 48; 50; 57; 60; 64; 75; 76; 80; 95; 96; 100; 114; 120; 125;
   * 128; 150; 152; 160; 190; 192; 200; 228; 240; 250; 256]; */
  ...
  /*  else */
  /*      fprintf('Only decimation factors of 48 are currently supported.
   * Exiting.') */
  /*  end */
  /*  if decimationFactor == 2 */
  /*      airspychannelize2(rawSampleRate); */
  ...
  if (decimationFactor == 100.0) {
    ...
    printf("Unsupported number of channels requests. Exiting.");
    fflush(stdout);
  }
}

/* End of code generation (airspy_channelize.c) */
